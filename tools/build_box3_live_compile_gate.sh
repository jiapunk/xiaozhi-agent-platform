...
product_build_dir="$product_project_dir/build-box3-live-compile"
product_sdkconfig="$product_build_dir/sdkconfig"
product_defaults="$product_project_dir/sdkconfig.box3.defaults;$product_project_dir/sdkconfig.secure-storage.defaults;$product_project_dir/sdkconfig.live-runtime-compile.defaults"
...
echo "compile-only live runtime gate PASS; do not flash this .invalid profile"
