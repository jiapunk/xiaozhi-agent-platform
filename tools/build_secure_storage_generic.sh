...
product_build_dir="$product_project_dir/build-generic-secure-storage"
product_sdkconfig="$product_build_dir/sdkconfig"
product_defaults="$product_project_dir/sdkconfig.defaults;$product_project_dir/sdkconfig.secure-storage.defaults"
