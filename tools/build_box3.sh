...
product_build_dir="$product_project_dir/build-box3"
product_sdkconfig="$product_build_dir/sdkconfig"
product_defaults="$product_project_dir/sdkconfig.box3.defaults"
...
# set-target performs a clean, reproducible rebuild inside the dedicated
# BOX-3 build directory. Product source and the reference build are untouched.
